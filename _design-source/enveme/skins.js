/* ENVEME — three warm-leaning style worlds.
   Each skin re-skins the whole page (CSS vars + fonts) AND the 3D scene
   (lighting, exposure, background, floor). The motion architecture is shared. */
...
window.SKINS = {
  heritage: {
    ...
    fonts: { display: "'Saira Condensed', sans-serif", body: "'Saira', sans-serif", mono: "'JetBrains Mono', monospace" },
    css: {
      '--bg':        '#EBE2CF',
      '--bg2':       '#E0D4B9',
  ...
  cinematic: {
    ...
    fonts: { display: "'Instrument Serif', serif", body: "'Newsreader', serif", mono: "'JetBrains Mono', monospace" },
    css: {
      '--bg':        '#17120F',
      '--bg2':       '#1E1712',
  ...
  chrome: {
    ...
    fonts: { display: "'Archivo', sans-serif", body: "'Archivo', sans-serif", mono: "'Spline Sans Mono', monospace" },
    css: {
      '--bg':        '#201B17',
      '--bg2':       '#2A231D',
...
window.SKIN_ORDER = ['heritage', 'cinematic', 'chrome'];
